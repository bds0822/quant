...
IYR = Ticker("IYR", desc="iShares U.S. Real Estate ETF")
...
IYR_H = Ticker("IYR", name="IYR_H", desc="iShares US Real Estate ETF(H)", currency="KRW")
...
# K-ETFs
KODEX_SNP_500 = Ticker("379800", name="KODEX S&P 500", currency="KRW", data_source="naver")
TIGER_SNP_500 = Ticker("360750", name="TIGER S&P 500", currency="KRW", data_source="naver")

KODEX_NASDAQ_100 = Ticker("379810", name="KODEX NASDAQ 100", currency="KRW", data_source="naver")
...
PLUS_EFA_H = Ticker("195970", name="PLUS EFA(H)", desc="PLUS MSCI EAFE(H)", currency="KRW", data_source="naver")
PLUS_EEM_H = Ticker("195980", name="PLUS EEM(H)", desc="PLUS MSCI Emerging Markets(H)", currency="KRW", data_source="naver")
KODEX_IYR_H = Ticker("352560", name="KODEX IYR(H)", desc="KODEX DJI US Real Estate(H)", currency="KRW", data_source="naver")

KODEX_AGG_H = Ticker("437080", name="KODEX AGG(H)", desc="KODEX AGG SRI Active(H)", currency="KRW", data_source="naver")
KODEX_TIP = Ticker("468370", name="KODEX TIP", desc="KODEX ", currency="KRW", data_source="naver")
KODEX_HYG = Ticker("468380", name="KODEX HYG", desc="KODEX ", currency="KRW", data_source="naver")

KODEX_LQD = Ticker("468630", name="KODEX LQD", desc="KODEX ", currency="KRW", data_source="naver")
PLUS_LQD = Ticker("332620", name="PLUS LQD", desc="PLUS 15+ Year AAA A US Corporate Bond", currency="KRW", data_source="naver")

ACE_US_BOND = Ticker("476760", name="ACE US Bonds(20+y)", desc="ACE US 20+ Year Treasury Bonds Active", currency="KRW", data_source="naver")
...
RISE_US_BOND_F_H = Ticker("267440", name="RISE US Bonds(20+y)(H)", desc="RISE US 20+ Year Treasury Bonds Future(H)", currency="KRW", data_source="naver")

KODEX_US_NOTE_F = Ticker("308620", name="KODEX US Bonds(10y)", desc="KODEX US 10 Year Treasury Bonds Future", currency="KRW", data_source="naver")
...
KODEX_US_SOFR_BIL = Ticker("455030", name="KODEX US SOFR Bills", desc="KODEX USD SOFR Active", currency="KRW", data_source="naver")
TIGER_US_SOFR_BIL = Ticker("456610", name="TIGER US SOFR Bills", desc="TIGER USD SOFR Active", currency="KRW", data_source="naver")
